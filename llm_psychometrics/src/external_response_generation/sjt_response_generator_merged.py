...
class SJTResponseRunner:
    ...
    def run(self) -> ExperimentResults:
        ...
        total_responses = persona_count * len(sjts) * self.args.n_times
        if defaults_used > 0:
            print(
                ...
                f"These responses were assigned '1' regardless of persona — check experiment validity."
            )
        else:
